...
- Run the following commands to set the variable
```bash
...
**Important**: Before moving on to subsequent steps, make sure that if you are running these stages manually from the command line, that your default project is set to the 'automation' project created in this step.
...
```
And to set the gcloud project default in your CLI. Fill in the project from the project_ids above where `<prefix>-prod-iac-core-0` goes.
```bash
...
| [organization.tf](./organization.tf) | Organization-level IAM. | <code>folder</code> · <code>organization</code> | <code>google_assured_workloads_workload</code> |
...
| [bootstrap_project](variables.tf#L40) | Bootstrap project. | <code>string</code> | ✓ |  |  |
| [organization](variables.tf#L256) | Organization details. | <code title="object&#40;&#123;&#10;  id          &#61; number&#10;  domain      &#61; optional&#40;string&#41;&#10;  customer_id &#61; optional&#40;string&#41;&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> | ✓ |  |  |
| [prefix](variables.tf#L271) | Prefix used for resources that need unique names. Use 9 characters or less. | <code>string</code> | ✓ |  |  |
| [assured_workloads](variables.tf#L17) | Configuration for Assured Workloads. | <code title="object&#40;&#123;&#10;  regime   &#61; string&#10;  location &#61; string&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> |  | <code title="&#123;&#10;  regime   &#61; &#34;IL5&#34;&#10;  location &#61; &#34;US&#34;&#10;&#125;">&#123;&#8230;&#125;</code> |  |
| [bootstrap_user](variables.tf#L45) | Email of the nominal user running this stage for the first time. | <code>string</code> |  | <code>null</code> |  |
...
| [custom_roles](variables.tf#L97) | Map of role names => list of permissions to additionally create at the organization level. | <code>map&#40;list&#40;string&#41;&#41;</code> |  | <code>&#123;&#125;</code> |  |
| [essential_contacts](variables.tf#L104) | Email used for essential contacts, unset if null. | <code>string</code> |  | <code>null</code> |  |
...
| [logging_kms_key](variables.tf#L233) | value of the KMS key used for logging. | <code>string</code> |  | <code>null</code> |  |
| [org_policies_config](variables.tf#L239) | Organization policies customization. | <code title="object&#40;&#123;&#10;  constraints &#61; optional&#40;object&#40;&#123;&#10;    allowed_policy_member_domains &#61; optional&#40;list&#40;string&#41;, &#91;&#93;&#41;&#10;  &#125;&#41;, &#123;&#125;&#41;&#10;  import_defaults &#61; optional&#40;bool, false&#41;&#10;  tag_name        &#61; optional&#40;string, &#34;org-policies&#34;&#41;&#10;  tag_values &#61; optional&#40;map&#40;object&#40;&#123;&#10;    description &#61; optional&#40;string, &#34;Managed by the Terraform organization module.&#34;&#41;&#10;    iam         &#61; optional&#40;map&#40;list&#40;string&#41;&#41;, &#123;&#125;&#41;&#10;    id          &#61; optional&#40;string&#41;&#10;  &#125;&#41;&#41;, &#123;&#125;&#41;&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> |  | <code>&#123;&#125;</code> |  |
| [outputs_location](variables.tf#L265) | Enable writing provider, tfvars and CI/CD workflow files to local filesystem. Leave null to disable. | <code>string</code> |  | <code>null</code> |  |
| [project_parent_ids](variables.tf#L280) | Optional parents for projects created here in folders/nnnnnnn format. Null values will use the organization as parent. | <code title="object&#40;&#123;&#10;  automation &#61; optional&#40;string&#41;&#10;  billing    &#61; optional&#40;string&#41;&#10;  logging    &#61; optional&#40;string&#41;&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> |  | <code>&#123;&#125;</code> |  |
| [workforce_identity_providers](variables.tf#L291) | Workforce Identity Federation pools. | <code title="map&#40;object&#40;&#123;&#10;  attribute_condition &#61; optional&#40;string&#41;&#10;  issuer              &#61; string&#10;  display_name        &#61; string&#10;  description         &#61; string&#10;  disabled            &#61; optional&#40;bool, false&#41;&#10;  saml &#61; optional&#40;object&#40;&#123;&#10;    idp_metadata_xml &#61; string&#10;  &#125;&#41;, null&#41;&#10;&#125;&#41;&#41;">map&#40;object&#40;&#123;&#8230;&#125;&#41;&#41;</code> |  | <code>&#123;&#125;</code> |  |
| [workload_identity_providers](variables.tf#L307) | Workload Identity Federation pools. The `cicd_repositories` variable references keys here. | <code title="map&#40;object&#40;&#123;&#10;  attribute_condition &#61; optional&#40;string&#41;&#10;  issuer              &#61; string&#10;  custom_settings &#61; optional&#40;object&#40;&#123;&#10;    issuer_uri &#61; optional&#40;string&#41;&#10;    audiences  &#61; optional&#40;list&#40;string&#41;, &#91;&#93;&#41;&#10;    jwks_json  &#61; optional&#40;string&#41;&#10;  &#125;&#41;, &#123;&#125;&#41;&#10;&#125;&#41;&#41;">map&#40;object&#40;&#123;&#8230;&#125;&#41;&#41;</code> |  | <code>&#123;&#125;</code> |  |

## Outputs

| name | description | sensitive | consumers |
|---|---|:---:|---|
| [assured_workload](outputs.tf#L127) | Assured Workload folder for the deployment. |  |  |
| [automation](outputs.tf#L132) | Automation resources. |  |  |
| [billing_dataset](outputs.tf#L137) | BigQuery dataset prepared for billing export. |  |  |
| [cicd_repositories](outputs.tf#L142) | CI/CD repository configurations. |  |  |
| [common_services_folder](outputs.tf#L154) | Common services folder where non-tenant related resources should be kept. |  |  |
| [custom_roles](outputs.tf#L159) | Organization-level custom roles. |  |  |
| [outputs_bucket](outputs.tf#L164) | GCS bucket where generated output files are stored. |  |  |
| [project_ids](outputs.tf#L169) | Projects created by this stage. |  |  |
| [providers](outputs.tf#L179) | Terraform provider files for this stage and dependent stages. | ✓ | <code>stage-01</code> |
| [service_accounts](outputs.tf#L186) | Automation service accounts created by this stage. |  |  |
| [tfvars](outputs.tf#L204) | Terraform variable files for the following stages. | ✓ |  |
| [workforce_identity_pool](outputs.tf#L210) | Workforce Identity Federation pool. |  |  |
| [workload_identity_pool](outputs.tf#L219) | Workload Identity Federation pool and providers. |  |  |
<!-- END TFDOC -->
