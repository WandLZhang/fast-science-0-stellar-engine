...
|---|---|:---:|
| [alert_email](outputs.tf#L128) | Email to receive log alerts. |  |
| [assured_workload](outputs.tf#L133) | Assured Workload folder for the deployment. |  |
| [automation](outputs.tf#L138) | Automation resources. |  |
| [billing_dataset](outputs.tf#L143) | BigQuery dataset prepared for billing export. |  |
| [cicd_repositories](outputs.tf#L148) | CI/CD repository configurations. |  |
| [common_services_folder](outputs.tf#L160) | Common services folder where non-tenant related resources should be kept. |  |
| [custom_roles](outputs.tf#L165) | Organization-level custom roles. |  |
| [outputs_bucket](outputs.tf#L170) | GCS bucket where generated output files are stored. |  |
| [project_ids](outputs.tf#L175) | Projects created by this stage. |  |
| [providers](outputs.tf#L185) | Terraform provider files for this stage and dependent stages. | ✓ |
| [service_accounts](outputs.tf#L192) | Automation service accounts created by this stage. |  |
| [tfvars](outputs.tf#L210) | Terraform variable files for the following stages. | ✓ |
