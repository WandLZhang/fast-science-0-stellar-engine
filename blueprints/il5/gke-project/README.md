...
| [main_project_id](variables.tf#L102) | The ID of the project in which to create the GKE cluster. | <code>string</code> | ✓ |  |
| [master_authorized_ranges_ip_ranges](variables.tf#L107) | The CIDR Range for the GKE Nodes Pool when enabled Private End Point with master aurhotized ranges of CIDR. | <code>string</code> | ✓ |  |
| [network_name](variables.tf#L112) | The VPC Name. | <code>string</code> | ✓ |  |
| [node_config_tags](variables.tf#L118) | The Tags on the Node Configuration. | <code>list&#40;string&#41;</code> | ✓ |  |
| [node_disk_size_gb](variables.tf#L124) | The disk size in GB to be given to each node. | <code>number</code> | ✓ |  |
| [nodepool_node_count](variables.tf#L135) | Number of node per zone in the Nodepool. | <code title="object&#40;&#123;&#10;  current &#61; optional&#40;number&#41;&#10;  initial &#61; number&#10;&#125;&#41;">object&#40;&#123;&#8230;&#125;&#41;</code> | ✓ |  |
| [region](variables.tf#L144) | The GCP region to use for the resources. | <code>string</code> | ✓ |  |
| [remove_default_node_pool](variables.tf#L150) | The Default NodePool remove it or not. | <code>bool</code> | ✓ |  |
| [subnetwork_ip_cidr_range_1](variables.tf#L156) | The CIDR Range for the VPC Subnet. | <code>string</code> | ✓ |  |
| [subnetwork_name](variables.tf#L162) | The Subnet Name. | <code>string</code> | ✓ |  |
| [subnetwork_secondary_ip_range_pods_1](variables.tf#L168) | The CIDR Range for the secondary IP CIDR Ranges for the k8s pods. | <code>string</code> | ✓ |  |
| [subnetwork_secondary_ip_range_services_1](variables.tf#L174) | The CIDR Range for the secondary IP CIDR Ranges for the k8s services. | <code>string</code> | ✓ |  |
...
| [node_machine_type](variables.tf#L129) | The Node Machine type to be used in the NodePool. | <code>string</code> |  | <code>&#34;n2d-standard-2&#34;</code> |
