...
|---|---|:---:|:---:|:---:|
| [main_project_id](variables.tf#L7) | Project id. | <code>string</code> | ✓ |  |
| [name](variables.tf#L12) | Name of DataFusion instance. | <code>string</code> | ✓ |  |
| [network_name](variables.tf#L17) | Full path to VPC. | <code>string</code> | ✓ |  |
| [network_project_id](variables.tf#L22) | Landing project id. | <code>string</code> | ✓ |  |
| [region](variables.tf#L27) | Location to deploy job. | <code>string</code> | ✓ |  |
| [subnetwork_name](variables.tf#L32) | Full path to subnet. | <code>string</code> | ✓ |  |
| [kms_key_name](variables.tf#L1) | Full path to KMS key for pubsub. | <code>string</code> |  | <code>null</code> |
