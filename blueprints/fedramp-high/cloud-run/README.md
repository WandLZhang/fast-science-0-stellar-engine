...
| [kms_key](variables.tf#L36) | Path to the kms key to use. | <code>string</code> | ✓ |  |
| [name](variables.tf#L47) | Name of the cloud run instance to be created. | <code>string</code> | ✓ |  |
| [project_id](variables.tf#L58) | The Project ID. | <code>string</code> | ✓ |  |
...
| [memory](variables.tf#L41) | Sets the memory limit. 512Mi = 512MiB. | <code>string</code> |  | <code>&#34;512Mi&#34;</code> |
| [port](variables.tf#L52) | Mapping of port number and port name to open. | <code>number</code> |  | <code>8080</code> |
