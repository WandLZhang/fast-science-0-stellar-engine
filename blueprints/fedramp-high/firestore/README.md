...
|---|---|:---:|:---:|:---:|
| [database_name](variables.tf#L11) | The name of the Firestore database instance. | <code>string</code> | ✓ |  |
| [location_id](variables.tf#L22) | The location ID where the Firestore database will be created. | <code>string</code> | ✓ |  |
| [project_id](variables.tf#L27) | The ID of the Google Cloud project. | <code>string</code> | ✓ |  |
